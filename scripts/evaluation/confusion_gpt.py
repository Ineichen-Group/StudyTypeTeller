...
def generate_confusion_matrix_from_log(file_path, label_mapping, model_name, output_dir):
    # Load the predictions
    data = load_predictions(file_path)
    # Extract predictions and true labels
    predictions = data['accepted_label_numerical']
    true_labels = data['gpt_predictions_P11_4_numerical']
...
def main():
    ...
    generate_confusion_matrix_from_log(file_path, label_mapping, model_name, output_dir)
