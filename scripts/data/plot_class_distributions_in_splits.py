...
def main():
    ...
    train_file = "./../../data/data_splits_stratified/6-2-2_all_classes/train.csv"
    val_file = "./../../data/data_splits_stratified/6-2-2_all_classes/val.csv"
    test_file = "./../../data/data_splits_stratified/6-2-2_all_classes/test.csv"

    save_dir = "./../../data/data_splits_stratified/6-2-2_all_classes/plots"
    ...
    plot_class_distribution(train_data, val_data, test_data, 'binary_label', save_dir)

    # Plot class distribution for multi_label
    plot_class_distribution(train_data, val_data, test_data, 'multi_label', save_dir)
